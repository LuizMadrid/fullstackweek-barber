      ...
      <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
        <SheetTrigger asChild>
          <button className="min-w-full">
            <Card>
              <CardContent
                className={isBookingPast ? "flex p-0 grayscale" : "flex p-0"}
              >
                <div className="flex flex-[3] items-start flex-col gap-2 py-5 px-8">
                  ...
                  <h2 className="text-lg font-bold sm:text-xs 2md:text-lg">
                  ...
                  <div className="flex items-center gap-2 text-center">
                    ...
                    <h3 className="text-base sm:text-xs 2md:text-base">
                ...
                <div className="flex flex-[1] flex-col gap-1 items-center justify-center border-l border-secondary p-5">
                  ...
                  <p className="text-4xl">{format(booking.date, "dd")}</p>
        ...
        <SheetContent className="p-0">
          ...
          <div
            className={
              isBookingPast
                ? "px-5 pt-6 flex flex-col gap-6 grayscale"
                : "px-5 pt-6 flex flex-col gap-6"
            }
          >
        ...
        <DialogContent className="flex flex-col items-center justify-center border-none rounded-lg w-fit">
          <DialogHeader className="space-y-4">
            ...
            <DialogDescription className="text-center text-gray-400">
              Tem certeza que deseja cancelar esse agendamento? <br /> Essa ação
