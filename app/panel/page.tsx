			...
			<div className="p-5">
				<div className="flex flex-col space-y-8">
					<div className="relative space-y-2">
						<h1 className="text-lg font-bold tracking-wide text-gray-400 capitalize">
              Suas barbearias
						</h1>

						{barbershops.length === 0 ? (
							<p className="p-6 mt-5 tracking-wide text-center text-gray-400 uppercase rounded-lg bg-card">
                Você não criou barbearias ainda.
							</p>
						) : (
							<div className="px-5">
								<CarouselComponent>
									{barbershops.map((barbershop) => (
										<CarouselItem
											key={barbershop.id}
											className="basis-48 sm:basis-60"
										>
											<Dialog>
              ...
              Agendados Hoje
						...
						{todaysBookings.length === 0 ? (
							<p className="p-6 mt-5 tracking-wide text-center text-gray-400 uppercase rounded-lg bg-card">
                Você não possui serviços agendamentos para hoje.
							</p>
						) : (
