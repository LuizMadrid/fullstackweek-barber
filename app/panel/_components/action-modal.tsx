...
import { Dialog, DialogClose, DialogContent, DialogDescription, DialogHeader, DialogTitle } from '@/app/_components/ui/dialog';
	...
	return (
		<>
			<DialogContent className='flex flex-col items-center justify-center border-none rounded-lg w-fit'>
				<DialogHeader>
					<DialogTitle className='text-center'>Qual ação deseja fazer ?</DialogTitle>
				...
				<div className='flex justify-between w-full gap-4'>
					<Button 
						...
						<Link href={`/panel/update/${barbershop.id}`}>
							Editar
						</Link>
					</Button>
			...
			<Dialog open={isConfirming} onOpenChange={setIsConfirming}>
				<DialogContent className='flex flex-col items-center justify-center border-none rounded-lg w-fit'>
					<DialogHeader className='space-y-4'>
						<DialogTitle className='text-center capitalize'>Deletar Barbearia</DialogTitle>
						<DialogDescription className='text-center text-gray-400'>
